    ...
    Pages.prototype.reponsiveTabs = function() {
        //Dropdown FX
         $('[data-init-reponsive-tabs="dropdownfx"]').each(function() {
            ...
            $(select).wrap('<div class="nav-tab-dropdown cs-wrapper full-width d-sm-none"></div>');
            new SelectFx(select);
         });
    }
...
(function($) {
    ...
    $(".sortable .row .sortable-column").sortable({
        connectWith: ".sortable .row .sortable-column",
        handle: ".card-header",
        cancel: ".card-close",
